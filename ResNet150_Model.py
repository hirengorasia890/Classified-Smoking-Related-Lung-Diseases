...
# Create a new model on top of the ResNet152 base
model = Sequential([
    base_model,
...
with open('E:\mini project\save_model\joblib_file\Lung_Cancer&Pneumonia_model_ResNet_Model[Version-1]evaluation_results.pkl', 'wb') as f:
    pickle.dump(evaluation_results, f)
print("Results saved to 'Lung_Cancer&Pneumonia_model_ResNet_Model[Version-1]evaluation_results.pkl'")
joblib.dump(model, 'E:\mini project\save_model\joblib_file\Lung_Cancer&Pneumonia_model_ResNet_Model[Version-1].pkl')
model_save_path = 'E:\mini project\save_model\keras_file\Lung_Cancer&Pneumonia_model_ResNet_Model[Version-1].keras'
try:
    # Save the model
